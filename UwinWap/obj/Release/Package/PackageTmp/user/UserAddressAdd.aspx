<%@ Page Title="" Language="C#" MasterPageFile="~/user/User.Master" AutoEventWireup="true" CodeBehind="UserAddressAdd.aspx.cs" Inherits="UwinWap.user.UserAddressAdd" %>
     ...
     <div class="com-content-area" id="js-com-content-area">
        ...
        <br />
            ...
            <div>
                <span>&nbsp;</span><p>
                    <span>
                        <asp:Button ID="Addbtn" runat="server" Text="添加" class="pxui-light-button" OnClick="Addbtn_Click"/>
